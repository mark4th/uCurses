// uC_json_key.c   json key name parsing
// -----------------------------------------------------------------------
...
static void struct_screen(void)
{
    ...
    if (active_screen == NULL)
    {
        ...
        // if we enable more than one screen then this must first
        // push the current active screen onto a stack wich the
        // screen close function will pop back off
        // todo?

        // note: if we do the above then every screen on the stack
        // will be destroyed by a winch and the stack will need to
        // be emptied.
