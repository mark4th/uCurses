...
API void uC_win_set_bold(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_set_flags(&win->attrs, uC_ATTR_FLAG_BOLD);
    }
}
...
API void uC_win_clr_bold(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_clr_flags(&win->attrs, uC_ATTR_FLAG_BOLD);
    }
}
...
API void uC_win_set_bdr_bold(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_set_flags(&win->bdr_attrs, uC_ATTR_FLAG_BOLD);
    }
}
...
API void uC_win_clr_bdr_bold(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_clr_flags(&win->bdr_attrs, uC_ATTR_FLAG_BOLD);
    }
}
...
API void uC_win_set_rev(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_set_flags(&win->attrs, uC_ATTR_FLAG_REV);
    }
}
...
API void uC_win_clr_rev(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_clr_flags(&win->attrs, uC_ATTR_FLAG_REV);
    }
}
...
API void uC_win_set_bdr_rev(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_set_flags(&win->bdr_attrs, uC_ATTR_FLAG_REV);
    }
}
...
API void uC_win_clr_bdr_rev(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_clr_flags(&win->bdr_attrs, uC_ATTR_FLAG_REV);
    }
}
...
API void uC_win_set_ul(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_set_flags(&win->attrs, uC_ATTR_FLAG_UL);
    }
}
...
API void uC_win_clr_ul(uC_window_t *win)
{
    if (win != NULL)
    {
        uC_attr_clr_flags(&win->attrs, uC_ATTR_FLAG_UL);
    }
}
...
API void uC_win_set_bdr_gray_bg(uC_window_t *win, uC_colors_gray_t color)
{
    if (win != NULL)
    {
        ...
        uC_attr_set_flags(&win->bdr_attrs, uC_ATTR_FLAG_GRAY_BG);
    }
}
